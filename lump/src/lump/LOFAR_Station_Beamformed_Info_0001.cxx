...
LOFAR_Station_Beamformed_Info_0001::LOFAR_Station_Beamformed_Info_0001(FILE* fp)
    throw()
{
    if(fread(reinterpret_cast<void*>(this),sizeof(LOFAR_Station_Beamformed_Info_0001),1,fp)
       != 1) {
        DEF_LOGGING_ERROR("cannot read in LOFAR_Station_Beamformed_Info_0001\n");
        memset(reinterpret_cast<void*>(this),0,sizeof(LOFAR_Station_Beamformed_Info_0001));
        return;
    }
...
size_t LOFAR_Station_Beamformed_Info_0001::write_to_file(FILE* fp) throw()
{
#if __BYTE_ORDER == __LITTLE_ENDIAN
    return fwrite(reinterpret_cast<void*>(this),
                  sizeof(LOFAR_Station_Beamformed_Info_0001),
                  1,
                  fp);
#else
    LOFAR_Station_Beamformed_Info_0001 temp = *this;
    temp.byteswap();
...
void LOFAR_Station_Beamformed_Info_0001::byteswap() throw()
{
    int16_t* i16;
    int32_t* i32;
    int64_t* i64;
    ...
    i16 = reinterpret_cast<int16_t*>(&PAD0); *i16 = LOFAR_Station_Swap_int16_t(*i16);
