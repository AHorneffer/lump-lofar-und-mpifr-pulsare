...
#ifndef LOFAR_Station_Beamformed_Writer_Raw0_H
#define LOFAR_Station_Beamformed_Writer_Raw0_H
...
//_CLASS  LOFAR_Station_Beamformed_Writer_Raw0
class LOFAR_Station_Beamformed_Writer_Raw0 :
...
public:
    ...
    virtual ~LOFAR_Station_Beamformed_Writer_Raw0();
...
protected:
    ...
    uint_fast32_t DATA_OUTPUT_LENGTH_CHAR;  // units of char size
...
private:
    ...
    static uint16_t WRITER_TYPE() throw() {return uint16_t(LOFAR_DOFF_RAW0_OUT);}
    ...
    // prevent copying
    LOFAR_Station_Beamformed_Writer_Raw0(const LOFAR_Station_Beamformed_Writer_Raw0& a);
    LOFAR_Station_Beamformed_Writer_Raw0& operator=(const LOFAR_Station_Beamformed_Writer_Raw0& a);
...
#endif // LOFAR_Station_Beamformed_Writer_Raw0_H
