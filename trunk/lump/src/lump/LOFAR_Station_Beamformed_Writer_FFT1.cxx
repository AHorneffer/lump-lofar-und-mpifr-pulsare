...
// code for the derived writer class for FFT spectra, case 1
//_HIST  DATE NAME PLACE INFO
// 2014 Sep 03  James M Anderson  --GFZ  start from LOFAR_Station_Beamformed_Writer_FFT0.cxx
...
// valid.  For this writer, the valid fraction is weighted by the time series
// weighting applied to the data (so that, in general, time samples near the
// middle of each series are weighted more than samples at the edges).
// The filename is
// filename_base.valid
//
// Filename file:
...
LOFAR_Station_Beamformed_Writer_FFT1::
...
int_fast32_t LOFAR_Station_Beamformed_Writer_FFT1::
