...
#ifndef LOFAR_Station_Beamformed_Writer_Raw1_H
#define LOFAR_Station_Beamformed_Writer_Raw1_H
...
//_CLASS  LOFAR_Station_Beamformed_Writer_Raw1
class LOFAR_Station_Beamformed_Writer_Raw1 :
...
public:
    ...
    virtual ~LOFAR_Station_Beamformed_Writer_Raw1();
...
private:
    ...
    static uint16_t WRITER_TYPE() throw() {return uint16_t(LOFAR_DOFF_RAW1_OUT);}
    ...
    // prevent copying
    LOFAR_Station_Beamformed_Writer_Raw1(const LOFAR_Station_Beamformed_Writer_Raw1& a);
    LOFAR_Station_Beamformed_Writer_Raw1& operator=(const LOFAR_Station_Beamformed_Writer_Raw1& a);
...
#endif // LOFAR_Station_Beamformed_Writer_Raw1_H
