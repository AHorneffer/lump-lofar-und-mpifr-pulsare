...
// code for the FFT spectra power, case 0
//_HIST  DATE NAME PLACE INFO
// 2013 Jan 11  James M Anderson  --MPIfR  start
// 2013 Feb 03  JMA  ---- fix flushing
...
// 2014 Aug 29  JMA  ---- fix num_spectrum_points_processed counting
...
LOFAR_Station_Beamformed_Writer_P_FFT0::
...
int_fast32_t LOFAR_Station_Beamformed_Writer_P_FFT0::
...
FFT_block() restrict throw()
{
    ...
    case L_Real32_t:
        {
            ...
            // pass on to the integrator
            return add_FFT_to_integration<Real32_t>();
        }
        break;
    case L_Real64_t:
        {
            ...
            ++num_spectrum_points_processed;
            // pass on to the integrator
            return add_FFT_to_integration<Real64_t>();
        }
        break;    
#ifdef JMA_CODE_HAVE_NATIVE_80_BIT_FLOAT
    case L_Real80_t:
        {
            ...
            ++num_spectrum_points_processed;
            // pass on to the integrator
            return add_FFT_to_integration<Real80_t>();
        }
        break;    
#endif // JMA_CODE_HAVE_NATIVE_80_BIT_FLOAT
#ifdef JMA_CODE_HAVE_NATIVE_128_BIT_FLOAT
    case L_Real128_t:
        {
            ...
            ++num_spectrum_points_processed;
            // pass on to the integrator
            return add_FFT_to_integration<Real128_t>();
        }
        break;    
#endif // JMA_CODE_HAVE_NATIVE_128_BIT_FLOAT
    default:
    ...
    DEF_LOGGING_CRITICAL("Programmer error: no return from within switch.\n");
    exit(1);
    return int_fast32_t(LOFAR_WRITER_RETVAL_PROGRAMMER_ERROR);
}
