...
// Derived class for writing FFT spectra, case 1
//_HIST  DATE NAME PLACE INFO
// 2014 Sep 03  James M Anderson  --GFZ  start from LOFAR_Station_Beamformed_Writer_FFT0.h
...
#ifndef LOFAR_Station_Beamformed_Writer_FFT1_H
#define LOFAR_Station_Beamformed_Writer_FFT1_H
...
//_CLASS  LOFAR_Station_Beamformed_Writer_FFT1
class LOFAR_Station_Beamformed_Writer_FFT1 :
...
public:
    LOFAR_Station_Beamformed_Writer_FFT1(const char* const restrict filename_base_,
    ...
    virtual ~LOFAR_Station_Beamformed_Writer_FFT1();
...
private:
    ...
    static uint16_t WRITER_TYPE() throw() {return uint16_t(LOFAR_DOFF_FFT1_OUT);}
    ...
    template<typename Tproc> int_fast32_t FFT_block() restrict throw()
    {
        ...
        return dump_FFT_to_output<Tproc>(Weighted_Valid_Sum);
    }
    ...
    template<typename Tproc> int_fast32_t dump_FFT_to_output(const Tproc Weighted_Valid_Sum) restrict throw()
    {
        ...
        const bool NEED_TO_SCALE = ((valid_samples_in_this_FFT != NUM_OUTPUT_CHANNELS) && (valid_samples_in_this_FFT > 0));
    ...
    // prevent copying
    LOFAR_Station_Beamformed_Writer_FFT1(const LOFAR_Station_Beamformed_Writer_FFT1& a);
    LOFAR_Station_Beamformed_Writer_FFT1& operator=(const LOFAR_Station_Beamformed_Writer_FFT1& a);
...
#endif // LOFAR_Station_Beamformed_Writer_FFT1_H
